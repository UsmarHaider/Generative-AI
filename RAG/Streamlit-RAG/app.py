...
def main():
    ...
    with st.sidebar:
        ...
        if st.session_state.documents_processed and st.session_state.vector_db:
            ...
            if st.button("💾 Save Embeddings to Folder"):
                st.session_state.vector_db.save_index("saved_embeddings/my_documents")
                st.success("Embeddings saved successfully to 'saved_embeddings/my_documents.*'")

        if st.button("📂 Load Saved Embeddings"):
            ...
            if vector_db.load_index("saved_embeddings/my_documents"):
                st.session_state.vector_db = vector_db
                st.session_state.documents_processed = True
